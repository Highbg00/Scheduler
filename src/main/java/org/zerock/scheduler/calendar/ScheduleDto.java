...
public class ScheduleDto {
    ...
    String schedule_subject, schedule_desc, schedule_share, schedule_mycolor;
    ...
    public String toString() {
        return "ScheduleDto [schedule_id=" + schedule_id + ", schedule_num=" + schedule_num + ", schedule_subject="
